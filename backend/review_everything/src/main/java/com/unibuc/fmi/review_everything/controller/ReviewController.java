...
public class ReviewController {
    ...
    public ResponseEntity<List<ReviewResponseDto>> findReviewsByUsername(@PathVariable String username) {
        return ResponseEntity.ok(reviewService.findReviewsByUsername(username));
    }
